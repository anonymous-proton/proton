...
RAW_SUBDIR = "raw"
TRACES_SUBDIR = RAW_SUBDIR
SCRATCH_SUBDIR = "scratch"
INPUTS_SUBDIR = "inputs"
OVERHEAD_SUBDIR = "with_overhead"
...
DEFAULT_OVERHEAD_STORAGE_ROOT = DEFAULT_STORAGE_ROOT / OVERHEAD_SUBDIR
DEFAULT_OVERHEAD_RAW_ROOT = DEFAULT_OVERHEAD_STORAGE_ROOT / RAW_SUBDIR
...
OVERHEAD_STORAGE_ROOT = STORAGE_ROOT / OVERHEAD_SUBDIR
OVERHEAD_RAW_ROOT = OVERHEAD_STORAGE_ROOT / RAW_SUBDIR
...
def component_overhead_raw_root(component: str) -> Path:
    """Return the directory under OVERHEAD_RAW_ROOT for overhead-instrumented runs."""
    return OVERHEAD_RAW_ROOT / component
